    ...
    <nav className="fixed top-3 left-0 w-full z-50">
      <div className="max-w-5xl mx-auto px-4">
        <div className="bg-[#120c08]/95 border border-[#3a281b] rounded-full px-5 py-3 flex items-center justify-between shadow-lg backdrop-blur-xl">
          ...
          <button
            onClick={toggleTheme}
            className="w-9 h-9 rounded-full bg-[#1a120c] border border-[#c98b55]/40 flex items-center justify-center text-[#c98b55] hover:bg-[#c98b55] hover:text-white transition"
          >
